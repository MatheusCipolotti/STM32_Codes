...
void PWM_TIM1_Config(void){
	...
	//Configura o CH1
	TIM1->CCMR1 &= ~(TIM_CCMR1_OC1M_Msk | TIM_CCMR1_OC2M_Msk); 		//Limpa bits OC1M e OC2M
	...
	//Ativar o contador e a saída principal
	TIM1->BDTR |= TIM_BDTR_MOE;    									//Ativa saídas principais
	TIM1->CR1 |= TIM_CR1_CEN;      									//Ativa contador
}
